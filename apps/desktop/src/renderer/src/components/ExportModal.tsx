      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4 py-2">
          ...
          <div className="relative">
            <pre className="p-3 rounded-lg bg-muted/40 border border-border text-xs font-mono text-foreground max-h-48 overflow-y-auto whitespace-pre-wrap">
              {content}
            </pre>
          </div>
        </div>
        ...
        <DialogFooter className="flex flex-col sm:flex-row gap-2 sm:justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              type="button"
              size="sm"
              className="text-xs h-8 flex items-center gap-1.5 cursor-pointer font-bold"
