...
export const SMART_PRESETS: PresetRoutine[] = [
  ...
  },
  {
    ...
    name: "Work",
    icon: "Briefcase",
    description: "Daily office essentials for meetings, desk work, and productivity.",
    items: [
      { name: "Laptop", emoji: "Laptop" },
  ...
  },
  {
    ...
    name: "Travel",
    icon: "Plane",
    description: "Packing checklist for flights, weekend getaways, and vacations.",
    items: [
  ...
  },
  {
    ...
    name: "Tech",
    icon: "Laptop",
    description: "Full gear loadout for digital nomads, developers, and tech power users.",
    items: [
      { name: "MacBook Pro", emoji: "Laptop" },
      { name: "USB-C Hub", emoji: "Plug" },
      { name: "Mechanical Keyboard", emoji: "Laptop" },
      { name: "Wireless Mouse", emoji: "Mouse" },
      { name: "Noise-Cancelling Headphones", emoji: "Headphones" },
      { name: "Power Bank", emoji: "Plug" },
    ],
  },
  {
    id: "photography",
    name: "Photography",
    icon: "Camera",
    description: "Camera gear, lenses, SD cards, and lighting accessories for shoots.",
    items: [
      { name: "Camera Body", emoji: "Camera" },
      { name: "Primary Lens", emoji: "Camera" },
      { name: "Extra Battery & Charger", emoji: "Plug" },
      { name: "SD Cards Case", emoji: "IdCard" },
      { name: "Lens Cleaning Kit", emoji: "Sparkles" },
    ],
  },
];
 ...
 * Example input: "USB Cable, Notebook, ID Card" or multi-line list with numbering/bullets.
 */
export function parseMultiItemInput(
  ...
  const rawTokens = rawInput
    ...
    .map((token) =>
      token
        .replace(/^[\s•\-*0-9.)[\]]+/, "") // Remove bullet points or numbers (including [3])
        .trim()
    )
